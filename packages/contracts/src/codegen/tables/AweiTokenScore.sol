...
ResourceId constant _tableId = ResourceId.wrap(
  bytes32(abi.encodePacked(RESOURCE_TABLE, bytes14(""), bytes16("AweiTokenScore")))
);
ResourceId constant AweiTokenScoreTableId = _tableId;

FieldLayout constant _fieldLayout = FieldLayout.wrap(
  0x0020010020000000000000000000000000000000000000000000000000000000
);

library AweiTokenScore {
  /**
   ...
   * @notice Get score.
   */
  function _getScore(uint256 tokenId) internal view returns (uint256 score) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(tokenId));
   ...
   * @notice Get score.
   */
  function get(uint256 tokenId) internal view returns (uint256 score) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(tokenId));
   ...
   * @notice Get score.
   */
  function _get(uint256 tokenId) internal view returns (uint256 score) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(tokenId));
   ...
   * @notice Set score.
   */
  function set(uint256 tokenId, uint256 score) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(tokenId));
   ...
   * @notice Set score.
   */
  function _set(uint256 tokenId, uint256 score) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(tokenId));
