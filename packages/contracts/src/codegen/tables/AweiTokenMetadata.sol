...
FieldLayout constant _fieldLayout = FieldLayout.wrap(
  0x0034020220140000000000000000000000000000000000000000000000000000
);

struct AweiTokenMetadataData {
  uint256 totalSupply;
  address proxy;
  string name;
  string symbol;
...
library AweiTokenMetadata {
   ...
   */
  function getTotalSupply(IStore _store, ResourceId _tableId) internal view returns (uint256 totalSupply) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   */
  function setTotalSupply(IStore _store, ResourceId _tableId, uint256 totalSupply) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);

    _store.setStaticField(_tableId, _keyTuple, 0, abi.encodePacked((totalSupply)), _fieldLayout);
  }

  /**
   * @notice Get proxy.
   */
  function getProxy(ResourceId _tableId) internal view returns (address proxy) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Get proxy.
   */
  function _getProxy(ResourceId _tableId) internal view returns (address proxy) {
    bytes32[] memory _keyTuple = new bytes32[](0);
  ...
  /**
   * @notice Get proxy (using the specified store).
   */
  function getProxy(IStore _store, ResourceId _tableId) internal view returns (address proxy) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Set proxy.
   */
  function setProxy(ResourceId _tableId, address proxy) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);

    StoreSwitch.setStaticField(_tableId, _keyTuple, 1, abi.encodePacked((proxy)), _fieldLayout);
  }

  /**
   * @notice Set proxy.
   */
  function _setProxy(ResourceId _tableId, address proxy) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);

    StoreCore.setStaticField(_tableId, _keyTuple, 1, abi.encodePacked((proxy)), _fieldLayout);
  }

  /**
   * @notice Set proxy (using the specified store).
   */
  function setProxy(IStore _store, ResourceId _tableId, address proxy) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);

    _store.setStaticField(_tableId, _keyTuple, 1, abi.encodePacked((proxy)), _fieldLayout);
  }
   ...
   */
  function getName(IStore _store, ResourceId _tableId) internal view returns (string memory name) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   */
  function setName(IStore _store, ResourceId _tableId, string memory name) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   */
  function lengthName(IStore _store, ResourceId _tableId) internal view returns (uint256) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @dev Reverts with Store_IndexOutOfBounds if `_index` is out of bounds for the array.
   */
  function getItemName(IStore _store, ResourceId _tableId, uint256 _index) internal view returns (string memory) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   */
  function pushName(IStore _store, ResourceId _tableId, string memory _slice) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   */
  function popName(IStore _store, ResourceId _tableId) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   */
  function updateName(IStore _store, ResourceId _tableId, uint256 _index, string memory _slice) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   */
  function getSymbol(IStore _store, ResourceId _tableId) internal view returns (string memory symbol) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   */
  function setSymbol(IStore _store, ResourceId _tableId, string memory symbol) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   */
  function lengthSymbol(IStore _store, ResourceId _tableId) internal view returns (uint256) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @dev Reverts with Store_IndexOutOfBounds if `_index` is out of bounds for the array.
   */
  function getItemSymbol(IStore _store, ResourceId _tableId, uint256 _index) internal view returns (string memory) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   */
  function pushSymbol(IStore _store, ResourceId _tableId, string memory _slice) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   */
  function popSymbol(IStore _store, ResourceId _tableId) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   */
  function updateSymbol(IStore _store, ResourceId _tableId, uint256 _index, string memory _slice) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   */
  function get(ResourceId _tableId) internal view returns (AweiTokenMetadataData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Get the full data.
   */
  function _get(ResourceId _tableId) internal view returns (AweiTokenMetadataData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   */
  function get(IStore _store, ResourceId _tableId) internal view returns (AweiTokenMetadataData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](0);
  ...
  function set(
    ...
    bytes memory _staticData = encodeStatic(totalSupply, proxy);
   ...
   */
  function set(ResourceId _tableId, AweiTokenMetadataData memory _table) internal {
    bytes memory _staticData = encodeStatic(_table.totalSupply, _table.proxy);
   ...
   * @notice Set the full data using the data struct.
   */
  function _set(ResourceId _tableId, AweiTokenMetadataData memory _table) internal {
    bytes memory _staticData = encodeStatic(_table.totalSupply, _table.proxy);
   ...
   */
  function set(IStore _store, ResourceId _tableId, AweiTokenMetadataData memory _table) internal {
    bytes memory _staticData = encodeStatic(_table.totalSupply, _table.proxy);
   ...
   */
  function decodeStatic(bytes memory _blob) internal pure returns (uint256 totalSupply, address proxy) {
    totalSupply = (uint256(Bytes.slice32(_blob, 0)));

    proxy = (address(Bytes.slice20(_blob, 32)));
  }
  ...
  ) internal pure returns (AweiTokenMetadataData memory _table) {
    (_table.totalSupply, _table.proxy) = decodeStatic(_staticData);
   ...
   */
  function encodeStatic(uint256 totalSupply, address proxy) internal pure returns (bytes memory) {
    return abi.encodePacked(totalSupply, proxy);
  }
